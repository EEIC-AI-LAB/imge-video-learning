...
source_video_dir = Path.cwd() / "data/videos"
save_frames_dir = Path.cwd() / "data/frames"
save_frames_dir.mkdir(exist_ok=True)

for file_path in source_video_dir.rglob("*.avi"):
    output_dir = save_frames_dir / file_path.stem
